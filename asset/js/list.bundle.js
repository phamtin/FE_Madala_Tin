...
/******/ 	return __webpack_require__(__webpack_require__.s = "./app/controller/index.js");
/******/ })
/************************************************************************/
/******/ ({
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _model_List_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../model/List.js */ \"./app/model/List.js\");\n/* harmony import */ var _view_listView_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../view/listView.js */ \"./app/view/listView.js\");\n\n\n\n//----------------- LIST CONTROLLER -------------------\n\nconst controlListProduct = async () => {\n    const data = new _model_List_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"]();\n    const dataList = await data.getResult();\n    _view_listView_js__WEBPACK_IMPORTED_MODULE_1__[\"renderResults\"](dataList);\n\n    setupEventListener();\n}\n\nvar setupEventListener = function () {\n    var nodesArray = Array.prototype.slice.call(document.querySelectorAll(\".buy-btn\"));\n    nodesArray.forEach(element => {\n        element.addEventListener('click', control);\n    })\n};\nvar idItem;\nconst control = (e) => {\n    idItem = e.target.parentNode.parentNode.id;\n    console.log(idItem);\n    localStorage.setItem('idItem', idItem);\n}\n\n\n['load'].forEach(event => window.addEventListener(event, controlListProduct));\n\n\n//# sourceURL=webpack:///./app/controller/index.js?");
